# Jordan Fitzgerald
# 4/2/2026
# Media Catalogue Project
# This file defines a media catalogue system with a parent Movie class and a child
...
def main():
    try:
        ...
        movie3 = Movie("Kung Fu Panda", 2008, 'John Stevenson', 90)
        catalogue.add(movie3)
        # catalogue.add("Not a movie")  # This will raise a MediaError
        ...
        series3 = TVSeries("The Simpsons", 1989, 'Matt Groening', 22, 37, 805)
        catalogue.add(series3)
        # catalogue.add(12345)  # This will raise a MediaError
